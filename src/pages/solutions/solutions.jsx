    ...
    return(
     ...
     <section>
        <div class="ai-green-v3">
          <div class="init-ai-section3" style={{marginTop:"300px",position:"absolute"}}>
            <div className="abusss3 ms-5" style={{color:"white",fontSize:"50px",fontWeight:"bold",fontFamily:"league spartans"}}>Our Industry Expertise & Solutions</div>
            <div class="init-red-bg ms-5 " style={{color:"white",fontSize:"30px",fontWeight:"bold",width:"600px",textAlign:"center"}}>
      ...
      <section className="py-12 bg-gray-200">
        <div className="flex flex-wrap justify-between gap-0 px-5">
          ...
          <a href="/Infrastructure-and-application-modernization">
            <img
              src={solutions2}
              alt="Manufacturing"
