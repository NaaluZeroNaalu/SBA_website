      ...
      const industries = [
        {
          title: "Manufacturing",
          img: ind1,
          description: "AI forecasts equipment failures, automates supply chains, and enhances quality control.",
        },
        {
          title: "BFSI",
          img: ind2,
          description: "AI streamlines customer inquiries and detects fraud in real-time.",
        },
        {
          title: "Media",
          img: ind3,
          description: "AI speeds up content creation and improves diagnostics.",
        },
        {
          title: "IT/ITES",
          img: ind4,
          description: "AI decreases IT support tickets and automates monitoring.",
        },
      ];
