...
<section className="relative w-full h-screen" id="topvideo">
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-center">
        {/* Large heading */}
        <div className="text-white text-8xl font-extrabold mt-5" style={{fontFamily:"league spartan"}} id="toptext">
          Open Hybrid Cloud
        </div>
...
<section className="py-8">
  ...
  <div className={`flex flex-col md:flex-row gap-6 md:gap-10 ${id % 2 === 0 ? 'md:flex-row' : 'md:flex-row-reverse'}`}>
    <div className="md:w-1/2 w-full md:pr-10">
      <h2 className="text-1xl font-bold mb-4" id="poweredbytitle">{val.title}</h2>
    ...
    <div className="md:w-1/2 w-full flex justify-center">
      <img
        src={val.img}
        alt={val.title}
        className={`rounded-lg h-auto w-full max-w-xs md:max-w-md object-cover ${val.anim}`}
      />
    </div>
  </div>
</div>
