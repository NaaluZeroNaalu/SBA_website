...
function Cyberresiliency(){
    ...
    return(
        ...
        <div class="ai-green-mas">
          <div class="init-ai-sectionmas1" style={{position:"absolute",bottom:"400px"}}>
            <div className="Infras" style={{color:"white",fontSize:"60px",fontWeight:"bold",marginLeft:"30px"}}>Cyber Resiliency </div>
            <div class="init-red-bg px-5" style={{color:"white",fontSize:"30px"}}>
        ...
        <div className="p-6 md:p-10 mb-5 bg-white rounded-lg shadow-md">
          <div className="flex flex-col md:flex-row gap-6 md:gap-10">
            <div className="md:w-1/2 w-full md:pl-6 mt-4 md:mt-6">
              <h2 className="text-3xl font-bold mb-6 md:mb-9 text-left " style={{fontFamily:"league spartans"}}>
                <b>
