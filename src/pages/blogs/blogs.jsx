...
function Blogs(){
    ...
    return(
      ...
      <section>
        <div className="flex justify-center items-center py-1" style={{height:"300px"}}>
          <p className="text-center text-lg sm:text-xl md:text-4xl lg:text-3xl px-1" style={{fontFamily:"league spartan"}}>
