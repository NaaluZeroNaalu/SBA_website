    ...
    const industries = [
      {
        ...
        img: Infra9,
        description: "We provide diverse cloud services, including compute, storage, and databases, through a pay-as-you-go model utilizing global infrastructure.",
      },
      {
        title: "Microsoft Azure",
        img: Infra10,
        description: "A flexible platform for building, managing, and deploying applications globally which include virtual machines, databases, AI, and IoT solutions.",
      },
      {
        title: "Google Cloud Platform",
        img: Infra11,
        description: "We offer an extensive suite of cloud services for computing, storage, data analytics, and machine learning, leveraging Google's infrastructure.",
      },
      {
        title: "Oracle Cloud",
        img: Infra12,
        description: "PaaS and IaaS solutions for building, deploying, and extending applications, supporting various programming languages and databases.",
      },
    ];
    ...
    const section3 = [
        {
          title: "jenkins",
          img: Infra17,
          description: "Automation of software development processes such as building, testing, and deploying code with Jenkins. It supports Continuous Integration and Continuous Delivery (CI/CD), enabling developers to detect issues early and deliver software faster.",
        },
        {
          title: "Terraform",
          img: Infra18,
          description: "We leverage Terraform, an open-source Infrastructure as Code tool, to define and manage data center infrastructure across multiple cloud providers. This ensures consistent, repeatable, and automated infrastructure provisioning.",
        },
        {
          title: "Ansible",
          img: Infra19,
          description: "Ansible is a powerful open-source automation tool for configuration management and application deployment using YAML playbooks. watsonx Code Assistant for Ansible enhances this process with AI-driven recommendations, streamlining playbook creation and maintenance for increased efficiency and productivity.",
        },
      ];
      ...
      const section2 = [
        {
          title: "Nginx",
          img: Infra14,
          description: "We reduce infrastructure complexity and boost web performance through our comprehensive solutions. Our services include reverse proxy, load balancing, and HTTP caching to optimize content delivery and handle high traffic. ",
        },
        {
          title: "Docker",
          img: Infra15,
          description: "We offer containerization services, including Docker implementation, to streamline development, improve scalability, and enhance application portability through efficient deployment and management of applications.",
        },
        {
          title: "Kubernetes",
          img: Infra16,
          description: "Modernization of legacy applications into microservices, eliminating dependencies for faster deployment across Kubernetes-based cloud environments. This enhances scalability and agility in cloud-native infrastructure.",
        },
      ];
      ...
      const section1 = [
        {
          title: "Power Servers",
          img: Infra2,
          description: "We deliver flexible solutions that support multiple operating systems such as AIX, IBM i, and Linux. These solutions provide robust performance and scalability, catering to diverse business needs. This enables clients to leverage advanced technology for mission-critical workloads and digital transformation initiatives.",
        },
        {
          title: "LinuxONE",
          img: Infra3,
          description: "Enterprise Linux servers built on mainframe tech. These platforms provide top-tier security, scalability, and performance. They support cloud-native and open-source workloads across various Linux distributions.",
        },
        {
          title: "Storage Fusion",
          img: Infra4,
          description: "A container-native data services platform for Red Hat OpenShift, simplifying data management across hybrid clouds with features like resilience, security, mobility, and discovery.",
        },
      ];
    ...
    <>
       <section>
        <div class="ai-green-mas">
          <div class="init-ai-sectionmas1 ms-5" style={{position:"absolute",bottom:"100px"}}>
            <div className="text-7xl Infras" style={{color:"white",fontFamily:"league spartan",fontWeight:"bold"}}>
              Infrastructure & Application Modernization
            </div>
            <div class="text-3xl init-red-bg px-5" style={{width:"600px",color:"white",fontFamily:"league spartan"}}>
      ...
      {/* <h1 className="display-4 text-center mb-4" style={{fontFamily:"league spartan"}}>Industries</h1> */}

      <div className="container">
        <div className="row justify-content-between">
          {section1.map((industry, index) => (
            <div
              key={index}
            ...
            >
              <div className="card overflow-hidden" style={{height:"300px",width:"400px"}}>
                <img src={industry.img} className="card-img-top" alt={industry.title}  style={{height:"300px",width:"600px"}}/>
                <div className="card-img-overlay d-flex flex-column justify-content-end">
                  <h5 className="card-title text-white">{industry.title}</h5>
                  <FaLongArrowAltRight className="text-white" />
                </div>
                <div
                  className={`card-body bg-primary text-white opacity-${hoveredIndex === index ? '100' : '0'} position-absolute top-0 left-0 right-0 bottom-0 d-flex flex-column justify-content-center align-items-center transition-opacity duration-300`}
                >
      ...
      <div className="container">
        <div className="row justify-content-between">
          {industries.map((industry, index) => (
            ...
            >
              <div className="card overflow-hidden" style={{height:"200px",width:"300px"}}>
                <img src={industry.img} className="card-img-top" alt={industry.title}  style={{height:"300px",width:"600px"}}/>
                <div className="card-img-overlay d-flex flex-column justify-content-end">
                  <h5 className="card-title text-white">{industry.title}</h5>
                  <FaLongArrowAltRight className="text-white" />
